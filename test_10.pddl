...
(= (seats Truck-14) 5)
(is-at Truck-14 TRU)
(= (move-consumption-rate Truck-14) 1.2)
...
(= (seats Truck-18) 2)
(is-at Truck-18 TRU)
(= (move-consumption-rate Truck-18) 1.2)
...
(= (seats Truck-19) 2)
(is-at Truck-19 TRU)
(= (move-consumption-rate Truck-19) 1.6)
...
(= (transport-consumption-rate Truck-20) 2.0)
(= (fuel Truck-20) 38095)
(= (speed Truck-20) 51)
...
(= (transport-consumption-rate Ambulance-11) 1.9)
(= (fuel Ambulance-11) 46937)
(= (speed Ambulance-11) 32)

(= (loaded-seats Ambulance-12) 0)
(= (seats Ambulance-12) 4)
(is-at Ambulance-12 HOS)
(= (move-consumption-rate Ambulance-12) 1.5)
(= (transport-consumption-rate Ambulance-12) 1.9)
(= (fuel Ambulance-12) 30773)
(= (speed Ambulance-12) 58)
...
(= (fuel Ambulance-15) 31254)
(= (speed Ambulance-15) 43)
...
(= (fuel Ambulance-16) 43465)
(= (speed Ambulance-16) 40)
...
(= (fuel Ambulance-17) 45573)
(= (speed Ambulance-17) 56)

(= (loaded-seats Ambulance-18) 0)
(= (seats Ambulance-18) 1)
(is-at Ambulance-18 HOS)
(= (move-consumption-rate Ambulance-18) 1.0)
(= (transport-consumption-rate Ambulance-18) 1.6)
(= (fuel Ambulance-18) 30925)
...
(= (fuel Ambulance-19) 44112)
(= (speed Ambulance-19) 58)

(= (loaded-seats Ambulance-20) 0)
(= (seats Ambulance-20) 1)
(is-at Ambulance-20 HOS)
(= (move-consumption-rate Ambulance-20) 1.1)
(= (transport-consumption-rate Ambulance-20) 1.8)
(= (fuel Ambulance-20) 40117)
(= (speed Ambulance-20) 50)
